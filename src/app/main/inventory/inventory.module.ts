...
import { ReceivingCostComponent } from './receiving-cost/receiving-cost.component';

@NgModule({
  declarations: [VendorSetupComponent, ProductSetupComponent, RequestsComponent, PurchaseOrdersComponent, AdjustmentsComponent, ApproveAdjustmentsComponent, ReportComponent, CountComponent, NewInventoryComponent, ProdcutComponent,ReceivingCostComponent],
  imports: [
    CommonModule, SharedModule, MatAutocompleteModule,
    NgApexchartsModule,
    RouterModule.forChild(
      [
        ...
        {
          path: 'receiving-cost',
          component: ReceivingCostComponent,
          pathMatch: 'full'
        }
      ]
    )
