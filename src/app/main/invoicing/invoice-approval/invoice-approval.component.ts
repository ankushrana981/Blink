...
@Component({
  selector: 'app-invoice-approval-view',
  ...
  export class InvoiceApprovalComponent extends BaseComponent implements OnInit {
 
    @ViewChild(InfiniteScrollDirective) infiniteScroll: InfiniteScrollDirective;
    
      // public ts :any="1559947334889";
      ...
      getUser(){
        ...
        var queryParams = 'ts='+this.ts+'&offset='+this.offset+'&limit='+this.limit+'&status='+this.status+'&type='+this.type;
        this.useSpinner = false;
        this.commonService.callApi('api/documents?'+queryParams,'','get').then(success => {
