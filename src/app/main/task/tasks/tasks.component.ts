...
export class TasksComponent extends BaseComponent implements OnInit {
  ...
  public scrollbarOptionsForCalendar = { axis: 'y', theme: 'minimal-dark', autoHideScrollbar: true };
  public calendarTimeList = [
      {id:1,  time: "08.00", description : "lorem Ipsum, This is static data you can play with it but Can't save it :)",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: false},
      {id:2,  time: "09.00", description : "lorem Ipsum has been the industry's",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: false},
      {id:3,  time: "10.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:4,  time: "11.00", description : "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: false},
      {id:5,  time: "12.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:6,  time: "13.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:7,  time: "14.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:8,  time: "15.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:9,  time: "16.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:10, time: "17.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:11, time: "18.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true},
      {id:12, time: "19.00", description : "",hourSelection : 0,minuteSelection : 0,timeDuration : 4,preparation : 4,isNew: true}
    ]
    taskDetails: any;
    taskList: any;
    TaskProgress = {
...
subTask_due_date: Date;
            ...
            if (alreadyCalled && isScrolled) {
                ...
                if (this.filterData.length > 0) {
                    for (let i = 0; i < this.filterData.length; i++) {
                        if (i != 0) {
                            if (this.filterData[i]["filterId"] == 1 && this.filterData[0]["filterId"] != 1) {
                                if (this.filterData[i]["subchildrange"] != "" && this.filterData[i]["subchildrange"] != null && this.filterData[i]["subchildrange"] != undefined) {
                                    queryParams["CreatedOnAfter"] = new Date(this.filterData[i]["childFilter"]).toISOString(); // this.data["createdOnAfter"]
                                    queryParams["CreatedOnBefore"] = new Date(this.filterData[i]["subchildrange"]).toISOString(); // this.data["createdOnBefore"]
                                    queryParams["CreatedOnType"] = 1;
                                }
                                else {
                                    queryParams["createdOn"] = new Date(this.filterData[i]["childFilter"]).toISOString(); //this.data["createdOn"];
                                    queryParams["createdOnType"] = this.filterData[i]["createdOnType"]; //this.data["createdOnType"];
                                }
                            }
                            else if (this.filterData[i]["filterId"] == 2 && this.filterData[0]["filterId"] != 2) {
                                if (this.filterData[i]["subchildrange"] != "" && this.filterData[i]["subchildrange"] != null && this.filterData[i]["subchildrange"] != undefined) {
                                    queryParams["dateFrom"] = new Date(this.filterData[i]["childFilter"]).toISOString(); // this.data["dateFrom"]
                                    queryParams["dateTo"] = new Date(this.filterData[i]["subchildrange"]).toISOString(); // this.data["dateTo"]
                                    queryParams["dueDateType"] = 1;
                                }
                                else {
                                    queryParams["dueDate"] = new Date(this.filterData[i]["childFilter"]).toISOString(); //this.data["dueDate"];
                                    queryParams["dueDateType"] = this.filterData[i]["dueDateType"]; //this.data["dueDateType"];
                                }
                            }
        ...
        this.commonService
            ...
            .then((success) => {
                if (success) {
                    ...
                    this.taskDashboardMaxPage = Math.floor(success.total / this.taskDashboardLimit); // this.limit
   ...
   *****************************************************/
    ...
    removeThisDataFromList(data){
        ...
        for(let i=0;i<this.saveUsersForWorkspaceSelection.length;i++){
            if(this.saveUsersForWorkspaceSelection[i].id !== data.id){
                this.usersForWorkspaceSelection.push(this.saveUsersForWorkspaceSelection[i]);
            }
        }
    }
    ...
    onScrollDownTaskDashboard(ev) {
        ...
        if (listcount > 0 && listcount > this.taskDashboardLimit && this.taskDashboardPage == 0 &&
            this.taskDashboardMaxPage > 0 && listcount != this.listRecordsTotal) {
            this.taskDashboardPage = (this.taskDashboardMaxPage - (Math.ceil((this.listRecordsTotal - listcount) / (this.taskDashboardLimit))));
        }
    ...
    setSaveUsersForWorkspaceSelection(){
        this.saveUsersForWorkspaceSelection = [{title:'Personal',id:-1},{title:'Task Dashboard',id:'-2'}]
        for(let i=0;i<this.users.length;i++){
            this.saveUsersForWorkspaceSelection.push({title:this.users[i].title,id:this.users[i].id});
        }
    ...
    removeSelected(index, i) {
        ...
        setTimeout(() => {
            if (i.filterId === 5) {
                ...
                if (i.childFilter === "Product") {          //if (i.childFilter === "Product") {
                ...
                if (this.data["createdOn"]) { delete this.data["createdOn"]; }              //this.data["createdOn"] = "";
                if (this.data["createdOnAfter"]) { delete this.data["createdOnAfter"]; }    //this.data["createdOnAfter"] = "";
                if (this.data["createdOnBefore"]) { delete this.data["createdOnBefore"]; }  //this.data["createdOnBefore"] = "";
                if (this.data["createdOnType"] == 0 || this.data["createdOnType"] == 1)     //this.data["createdOnType"] = "";
                { delete this.data["createdOnType"]; }      

                if (this.data["CreatedOn"]) { delete this.data["CreatedOn"]; }
                if (this.data["CreatedOnAfter"]) { delete this.data["CreatedOnAfter"]; }    
                if (this.data["CreatedOnBefore"]) { delete this.data["CreatedOnBefore"]; } 
                if (this.data["CreatedOnType"] == 0 || this.data["CreatedOnType"] == 1) { delete this.data["CreatedOnType"]; }
            } else if (i.filterId === 2) {
                if (this.data["dueDate"]) { delete this.data["dueDate"]; }          //this.data["dueDate"] = "";
                if (this.data["dateTo"]) { delete this.data["dateTo"]; }            //this.data["dateTo"] = "";
                if (this.data["dateFrom"]) { delete this.data["dateFrom"]; }        //this.data["dateFrom"] = "";
                if (this.data["dueDateType"] == 0 || this.data["dueDateType"] == 1) //this.data["dueDateType"] = "";
    ...
    *****************************************************/
    ...
    applyFilter(queryParams, terminate?) {
        ...
        if (queryParams.type == 0 || queryParams.type == 1 || queryParams.type == 2 || queryParams.type == 3 || queryParams.type == 4) { delete queryParams.type; }
        ...
        if (queryParams.createdOnBefore) {
            if (this.filterData.length > 0 && this.filterData[0]["filterId"] == 10) {
                this.tmpFilterData.createdOnBefore = new Date(queryParams.createdOnBefore).toISOString().split('.')[0] + 'Z';
        ...
        if (queryParams.createdOnAfter) {
            if (this.filterData.length > 0 && this.filterData[0]["filterId"] == 10) {
                this.tmpFilterData.createdOnAfter = new Date(queryParams.createdOnAfter).toISOString().split('.')[0] + 'Z';
        ...
        if (queryParams.createdOn) {
            if (this.filterData.length > 0 && this.filterData[0]["filterId"] == 10) {
                this.tmpFilterData.createdOn = new Date(queryParams.createdOn).toISOString().split('.')[0] + 'Z';
  ...
  *****************************************************/
   ...
   *****************************************************/
    ...
    applySelectedMOnthFilter(data) {
        ...
        this.startDateFrom = obtainedDate
            .clone()
            .startOf("month")
            .format();
        this.startDateTo = obtainedDate
            .clone()
            .endOf("month")
            .format();
        let queryParams: any = {
    ...
    progressRevertClick(record,status,flag,j){
        ...
        if(status-flag == 1){
            ...
            this.changeSubTaskStatusUpdateClose(record.taskId, record.subTaskId, flag, j);
        }
        else{
            this.dropdownClose();
        }
    ...
    undoClose(i,listRecordIndex){
        ...
        if (this.undoButtonClicked == 0 && listRecordIndex != null && listRecordIndex != undefined) {
            this.commonService.callApi("api/clients/taskDashboard/" + i, null, "get")
                .then((success) => {
    ...
    AddEditEventDescription(){
        ...
        this.calendar.time = String(this.calendar.hourSelection).padStart(2, '0') +"."+ String(this.calendar.minuteSelection).padStart(2, '0');
        for(let i=0; i<this.calendarTimeList.length; i++){
            if(this.calendarTimeList[i].id == this.calendar.id){
                ...
                if(Number(this.calendar.minuteSelection) + (this.calendar.timeDuration * 15) < 45){
                    let newEvent =  {
                        id: 100 + Math.floor(Math.random() * 100),
                        time:String(this.calendar.hourSelection).padStart(2, '0') +"."+ String(Number(this.calendar.minuteSelection) + (this.calendar.timeDuration * 15)).padStart(2, '0'),
                        hourSelection : this.calendar.hourSelection,
                        minuteSelection : Number(this.calendar.minuteSelection) + (this.calendar.timeDuration * 15),
                        timeDuration : 1,
                        preparation : 1,
                        description : "",
                        isNew: true
    ...
    createTaskModal(
        ...
        this.taskDetails = { taskData: task, subTaskData: editSubTaskData, listOfTask: this.taskList };
